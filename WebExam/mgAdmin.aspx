	...
	<body MS_POSITIONING="GridLayout" background ="image\bg2.jpg">
		<form id="Form1" method="post" runat="server">
			<P>
				...
				<asp:Label id="Label1" style="Z-INDEX: 103; LEFT: 328px; POSITION: absolute; TOP: 360px" runat="server">用户姓名</asp:Label>
				<asp:Label id="Label2" style="Z-INDEX: 104; LEFT: 328px; POSITION: absolute; TOP: 392px" runat="server">用户密码</asp:Label>
				<asp:Label id="lblWarning" style="Z-INDEX: 105; LEFT: 376px; POSITION: absolute; TOP: 312px"
					runat="server">添加管理员信息</asp:Label>
