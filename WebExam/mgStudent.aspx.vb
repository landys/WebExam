...
#End Region
    ...
    Private Sub Initialize()
        ...
        Dim strSql = "select userID, pwd from userTable where (role='0') order by userID"
        Try
            myDbConn.Open()
        ...
        Try
            ...
            Else
                If (myReader.Read()) Then
                    ...
                    Exit Sub
                Else
                    strSql = [String].Format("insert into userTable values('{0}','{1}','0')", Me.txtUserID.Text.Trim(), Me.txtPwd.Text)
                End If
            End If
            myDbConn.Close()
